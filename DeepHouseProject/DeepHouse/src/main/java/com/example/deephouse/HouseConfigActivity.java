...
public class HouseConfigActivity extends Activity implements ActionBar.TabListener {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            Integer position = getArguments().getInt(ARG_SECTION_NUMBER); //Session number
            String maison="";
            textView.setText("Valeurs mesurées");
            return rootView;
        }
    }
